...
public class GHTest {
	...
	public static void main(String[] args) {
		GuestHouseServiceImpl service = GuestHouseServiceImpl.getInstace();
        ...
        reservations.add(new Reservation(1, LocalDate.of(2025, 5, 1), LocalDate.of(2025, 5, 3), rooms.get(0), manager));
        reservations.add(new Reservation(2, LocalDate.of(2025, 5, 4), LocalDate.of(2025, 5, 6),rooms.get(1), manager));
        reservations.add(new Reservation(3, LocalDate.of(2025, 5, 10), LocalDate.of(2025, 5, 13),rooms.get(2), manager));
        reservations.add(new Reservation(4, LocalDate.of(2025, 5, 15), LocalDate.of(2025, 5, 18),rooms.get(3), manager));
        reservations.add(new Reservation(5, LocalDate.of(2025, 5, 6), LocalDate.of(2025, 5, 8),rooms.get(0), manager));
